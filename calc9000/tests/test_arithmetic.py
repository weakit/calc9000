...
def test_constants():
    assert p_str('N[Pi, 15-4]') == '3.14159265358979'
    assert p_str('N[E, 15-4]') == '2.71828182845905'
    assert p_str('N[EulerGamma, 15-4]') == '0.577215664901533'
    assert p_str('N[GoldenRatio, 15-4]') == '1.61803398874989'
    assert p_str('N[Catalan, 15-4]') == '0.915965594177219'
    assert p_str('N[Degree, 15-4]') == '0.0174532925199433'
...
def test_operations():
    ...
    assert p_str('N[100!, 5-4]') == '9.3326e+157'
